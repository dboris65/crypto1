...
//------------------------------------------------------------
procedure TfrCipher.add_lines(round : integer);
begin
...
//------------------------------------------------------------
procedure TfrCipher.print_state;
var i : integer;
    s : string;
begin
  s := '|';
...
//------------------------------------------------------------
procedure TfrCipher.print_round_key(key_index : byte);
var i : integer;
    s : string;
begin
  s := '|';
...
//------------------------------------------------------------
function TfrCipher.rcon (a : Byte) : Byte;
var c : Byte;
begin
  c := 1;
  if a = 0 then
...
//------------------------------------------------------------
// multiplication
function TfrCipher.galoa_mul_tab(a : Byte; b : Byte) : Byte;
var s, z : integer;
begin
  z := 0;
...
//------------------------------------------------------------
// MixColumns
procedure TfrCipher.MixColumns;
var c : Byte;
    a : array [0..3] of BYTE;
begin
...
//------------------------------------------------------------
procedure TfrCipher.Cipher(key_len : Integer);
var i, j : integer;
...
begin
    ...
    Memo1.Lines.Add(' Round    Start of         After          After           After          Round key');
    Memo1.Lines.Add(' Number     Round         SubBytes       ShiftRows       MixColums         Value');
    Memo1.Lines.Add('------------------------------------------------------------------------------------');
    print_state;
...
//------------------------------------------------------------
// key_exp_base
procedure TfrCipher.key_exp_base(i : Byte);
var a : Byte;
begin
		// RotWord
		//---------------------    ---------------------
...
procedure TfrCipher.KeyExpansion128;
var c, i, a : Byte;
begin
...
procedure TfrCipher.KeyExpansion192;
var c, i, a : Byte;
begin
...
procedure TfrCipher.KeyExpansion256;
var c, i, a : Byte;
begin
...
//------------------------------------------------------------
procedure TfrCipher.AddRoundKey(key_index : byte);
var i, j : Byte;
begin
  for j := 0 to 3 do
    for i := 0 to 3 do
...
procedure TfrCipher.rgTestVektoriClick(Sender: TObject);
begin
...
procedure TfrCipher.btCipherClick(Sender: TObject);
...
procedure TfrCipher.FormClose(Sender: TObject; var Action: TCloseAction);
begin
Action := caFree;
end;

procedure TfrCipher.FormShow(Sender: TObject);
begin
memo_line1 := '';
memo_line2 := '';
memo_line3 := '';
