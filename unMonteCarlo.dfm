object frMonteCarlo: TfrMonteCarlo
  ...
  object Panel1: TPanel
    ...
    object Label2: TLabel
      ...
      Width = 129
      Height = 13
      Caption = 'Predefined Plain Texts (PT)'
    end
    object Label3: TLabel
      ...
      Width = 175
      Height = 13
      Caption = 'Predefined Cipher Texts (CT) - results'
    end
    object Label4: TLabel
      ...
      Width = 190
      Height = 13
      Caption = 'Monte Carlo tests = 10000x encrypt PT, '
    end
    ...
    object btMonteCarloCipher: TButton
      ...
      Width = 145
      Height = 25
      Caption = 'MonteCarlo Cipher 1 by 1'
      TabOrder = 2
    ...
    object btMonteCarloAll: TButton
      ...
      Width = 145
      Height = 25
      Caption = 'MonteCarlo Cipher all 399'
      TabOrder = 8
